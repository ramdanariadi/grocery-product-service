...
//	"github.com/ramdanariadi/grocery-product-service/main/customresponses/transaction"
...
//	result, err := tx.ExecContext(context, sqlTransaction, model.Total, today.Format("2006-01-02 15:04:05"), model.UserId.proto, idTransaction, "", "", model.Name)
//	helpers.PanicIfError(err)
//
